...
class LoginForm:
    def __init__(self, callback):
        ...
        self.win.after(10, lambda: self.win.geometry(
            f"{win_width}x{win_height}+{x}+{y}"))

        # Đặt kích thước và vị trí cửa sổ
        # Màu nền
        self.win.configure(bg="#202227")

        canvas = Canvas(self.win, width=win_width,
                        height=win_height, highlightthickness=0, bg="#202227")
        ...
        name_label = Label(self.win, text="Welcome",
                           fg="white", bg="#202227", font=("Arial", 22))
        name_label.place(x=right_x + 70, y=label_y)

        # Entry để nhập tên
        self.name_entry = Entry(self.win, font=(
            "Arial", 16), width=24, bg="#32353c", fg="#d7d7da")  # Màu chữ khi chưa nhập
        # Đặt placeholder ban đầu
        self.name_entry.insert(0, "Nhập tên người chơi")
        # hoặc dùng ipady với .pack() / .grid()
        self.name_entry.place(x=right_x, y=entry_y, height=40)
        ...
        facebook_button = Button(self.win, image=facebook_photo,
                                 bg="#202227", border=0, highlightthickness=0, relief="flat")
        ...
        google_button = Button(self.win, image=google_photo, bg="#202227",
        ...
        apple_button = Button(self.win, image=apple_photo, bg="#202227",
                              border=0, highlightthickness=0, relief="flat")
        ...
        xbox_button = Button(self.win, image=xbox_photo, bg="#202227",
                             border=0, highlightthickness=0, relief="flat")
        ...
        sony_button = Button(self.win, image=sony_photo, bg="#202227",
                             border=0, highlightthickness=0, relief="flat")
